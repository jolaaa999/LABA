...
export const buildLayoutMobile: SceneLayout = {
  nodes: [
    n('n0', -0.88, 0.28, 0.34, { role: 'primary', label: '任务', scale: 1.22 }),
    n('n1', -0.4, 0.12, 0.3, {
      role: 'primary',
      label: '计划',
      hotspot: true,
    ...
    n('n3', 0.46, -0.2, 0.26, { role: 'primary', label: '观察', scale: 1.2 }),
    n('n4', 0.88, 0.08, 0.32, {
      role: 'primary',
      label: '结果',
      hotspot: true,
...
export const understandLayoutMobile: SceneLayout = {
  nodes: [
    ...
    n('n4', 0.78, -0.36, 0.28, { role: 'primary', label: '输出', scale: 1.18 }),
